...
#     assert matches_orca(triu, 1, 12, 13, exp_counts)
...
def test_495():
    ...
    exp_counts = [0.0, 4.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 12, 13, exp_counts)
...
def test_509():
    ...
    exp_counts = [4.0, 0.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 12, 13, exp_counts)
...
def test_510():
    ...
    exp_counts = [4.0, 4.0, 0.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 12, 13, exp_counts)
...
def test_766():
    ...
    exp_counts = [4.0, 4.0, 4.0, 0.0, 4.0]
    assert matches_orca(triu, 1, 12, 13, exp_counts)
...
def test_894():
    ...
    exp_counts = [4.0, 4.0, 4.0, 4.0, 0.0]
    assert matches_orca(triu, 1, 12, 13, exp_counts)
