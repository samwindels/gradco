...
#     assert matches_orca(triu, 1, 13, 13, exp_counts)
...
def test_495():
    ...
    exp_counts = [4.0, 1.0, 1.0, 1.0, 1.0]
    assert matches_orca(triu, 1, 13, 13, exp_counts)
...
def test_509():
    ...
    exp_counts = [1.0, 4.0, 1.0, 1.0, 1.0]
    assert matches_orca(triu, 1, 13, 13, exp_counts)
...
def test_510():
    ...
    exp_counts = [1.0, 1.0, 4.0, 1.0, 1.0]
    assert matches_orca(triu, 1, 13, 13, exp_counts)
...
def test_766():
    ...
    exp_counts = [1.0, 1.0, 1.0, 4.0, 1.0]
    assert matches_orca(triu, 1, 13, 13, exp_counts)
...
def test_894():
    ...
    exp_counts = [1.0, 1.0, 1.0, 1.0, 4.0]
    assert matches_orca(triu, 1, 13, 13, exp_counts)
