...
#     assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_183():
    ...
    exp_counts = [6.0, 6.0, 6.0, 6.0, 0.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_223():
    ...
    exp_counts = [6.0, 4.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_239():
    ...
    exp_counts = [6.0, 4.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_251():
    ...
    exp_counts = [4.0, 6.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_253():
    ...
    exp_counts = [4.0, 6.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_255():
    ...
    exp_counts = [8.0, 8.0, 6.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_347():
    ...
    exp_counts = [6.0, 6.0, 6.0, 0.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_367():
    ...
    exp_counts = [6.0, 4.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_381():
    ...
    exp_counts = [4.0, 6.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_383():
    ...
    exp_counts = [8.0, 8.0, 6.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_431():
    ...
    exp_counts = [6.0, 2.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_443():
    ...
    exp_counts = [4.0, 4.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_446():
    ...
    exp_counts = [4.0, 2.0, 6.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_447():
    ...
    exp_counts = [8.0, 6.0, 8.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_463():
    ...
    exp_counts = [6.0, 2.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_478():
    ...
    exp_counts = [4.0, 2.0, 6.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_479():
    ...
    exp_counts = [8.0, 6.0, 8.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_495():
    ...
    exp_counts = [8.0, 4.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_501():
    ...
    exp_counts = [2.0, 6.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_502():
    ...
    exp_counts = [2.0, 4.0, 6.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_503():
    ...
    exp_counts = [6.0, 8.0, 8.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_505():
    ...
    exp_counts = [2.0, 6.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_506():
    ...
    exp_counts = [2.0, 4.0, 6.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_507():
    ...
    exp_counts = [6.0, 8.0, 8.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_509():
    ...
    exp_counts = [4.0, 8.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_510():
    ...
    exp_counts = [4.0, 4.0, 8.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_511():
    ...
    exp_counts = [10.0, 10.0, 10.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_621():
    ...
    exp_counts = [6.0, 6.0, 0.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_639():
    ...
    exp_counts = [8.0, 8.0, 2.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_701():
    ...
    exp_counts = [4.0, 4.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_702():
    ...
    exp_counts = [4.0, 2.0, 4.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_703():
    ...
    exp_counts = [8.0, 6.0, 6.0, 8.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_719():
    ...
    exp_counts = [6.0, 2.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_750():
    ...
    exp_counts = [4.0, 2.0, 2.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_751():
    ...
    exp_counts = [8.0, 6.0, 2.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_758():
    ...
    exp_counts = [2.0, 4.0, 4.0, 6.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_759():
    ...
    exp_counts = [6.0, 8.0, 6.0, 8.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_761():
    ...
    exp_counts = [2.0, 6.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_764():
    ...
    exp_counts = [2.0, 4.0, 2.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_765():
    ...
    exp_counts = [6.0, 8.0, 2.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_766():
    ...
    exp_counts = [4.0, 4.0, 4.0, 8.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_767():
    ...
    exp_counts = [10.0, 10.0, 6.0, 10.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_861():
    ...
    exp_counts = [4.0, 4.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_862():
    ...
    exp_counts = [4.0, 2.0, 4.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_863():
    ...
    exp_counts = [8.0, 6.0, 6.0, 2.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_878():
    ...
    exp_counts = [4.0, 2.0, 2.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_879():
    ...
    exp_counts = [8.0, 6.0, 2.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_890():
    ...
    exp_counts = [2.0, 4.0, 4.0, 2.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_891():
    ...
    exp_counts = [6.0, 8.0, 6.0, 2.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_892():
    ...
    exp_counts = [2.0, 4.0, 2.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_893():
    ...
    exp_counts = [6.0, 8.0, 2.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_894():
    ...
    exp_counts = [4.0, 4.0, 4.0, 4.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_895():
    ...
    exp_counts = [10.0, 10.0, 6.0, 6.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_910():
    ...
    exp_counts = [6.0, 0.0, 6.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_927():
    ...
    exp_counts = [8.0, 2.0, 8.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_943():
    ...
    exp_counts = [8.0, 2.0, 6.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_951():
    ...
    exp_counts = [6.0, 6.0, 8.0, 8.0, 2.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_954():
    ...
    exp_counts = [2.0, 2.0, 6.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_956():
    ...
    exp_counts = [2.0, 2.0, 4.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_958():
    ...
    exp_counts = [6.0, 2.0, 8.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_959():
    ...
    exp_counts = [10.0, 6.0, 10.0, 10.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_975():
    ...
    exp_counts = [8.0, 2.0, 6.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_987():
    ...
    exp_counts = [6.0, 6.0, 8.0, 2.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_988():
    ...
    exp_counts = [2.0, 2.0, 4.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_990():
    ...
    exp_counts = [6.0, 2.0, 8.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_991():
    ...
    exp_counts = [10.0, 6.0, 10.0, 6.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1005():
    ...
    exp_counts = [6.0, 6.0, 2.0, 8.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1006():
    ...
    exp_counts = [6.0, 2.0, 6.0, 8.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1007():
    ...
    exp_counts = [10.0, 6.0, 6.0, 10.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1008():
    ...
    exp_counts = [0.0, 6.0, 6.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1011():
    ...
    exp_counts = [2.0, 8.0, 8.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1013():
    ...
    exp_counts = [2.0, 8.0, 6.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1014():
    ...
    exp_counts = [2.0, 6.0, 8.0, 8.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1015():
    ...
    exp_counts = [6.0, 10.0, 10.0, 10.0, 6.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1017():
    ...
    exp_counts = [2.0, 8.0, 6.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1018():
    ...
    exp_counts = [2.0, 6.0, 8.0, 6.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1019():
    ...
    exp_counts = [6.0, 10.0, 10.0, 6.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1020():
    ...
    exp_counts = [2.0, 6.0, 6.0, 8.0, 8.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1021():
    ...
    exp_counts = [6.0, 10.0, 6.0, 10.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1022():
    ...
    exp_counts = [6.0, 6.0, 10.0, 10.0, 10.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
...
def test_1023():
    ...
    exp_counts = [12.0, 12.0, 12.0, 12.0, 12.0]
    assert matches_orca(triu, 1, 3, 3, exp_counts)
