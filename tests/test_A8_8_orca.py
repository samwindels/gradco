...
#     assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_126():
    ...
    exp_counts = [6.0, 6.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_254():
    ...
    exp_counts = [4.0, 4.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_382():
    ...
    exp_counts = [4.0, 4.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_413():
    ...
    exp_counts = [6.0, 4.0, 6.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_445():
    ...
    exp_counts = [4.0, 2.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_477():
    ...
    exp_counts = [4.0, 2.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_483():
    ...
    exp_counts = [4.0, 6.0, 6.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_487():
    ...
    exp_counts = [2.0, 4.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_491():
    ...
    exp_counts = [2.0, 4.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_492():
    ...
    exp_counts = [4.0, 4.0, 4.0, 6.0, 6.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_493():
    ...
    exp_counts = [2.0, 2.0, 4.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_494():
    ...
    exp_counts = [2.0, 4.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_508():
    ...
    exp_counts = [4.0, 2.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_638():
    ...
    exp_counts = [4.0, 4.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_683():
    ...
    exp_counts = [6.0, 4.0, 4.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_725():
    ...
    exp_counts = [4.0, 6.0, 4.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_730():
    ...
    exp_counts = [4.0, 4.0, 6.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_822():
    ...
    exp_counts = [4.0, 4.0, 6.0, 6.0, 4.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_825():
    ...
    exp_counts = [4.0, 6.0, 4.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
...
def test_839():
    ...
    exp_counts = [6.0, 4.0, 4.0, 4.0, 6.0]
    assert matches_orca(triu, 1, 8, 8, exp_counts)
