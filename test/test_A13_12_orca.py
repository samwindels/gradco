...
def test_0():
    ...
    assert matches_orca(triu, 'A13_12', exp_counts)
...
def test_495():
    ...
    exp_counts = [8.0, 2.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A13_12', exp_counts)
...
def test_509():
    ...
    exp_counts = [2.0, 8.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A13_12', exp_counts)
...
def test_510():
    ...
    exp_counts = [2.0, 2.0, 8.0, 2.0, 2.0]
    assert matches_orca(triu, 'A13_12', exp_counts)
...
def test_766():
    ...
    exp_counts = [2.0, 2.0, 2.0, 8.0, 2.0]
    assert matches_orca(triu, 'A13_12', exp_counts)
...
def test_894():
    ...
    exp_counts = [2.0, 2.0, 2.0, 2.0, 8.0]
    assert matches_orca(triu, 'A13_12', exp_counts)
