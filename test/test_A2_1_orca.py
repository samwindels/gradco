...
def test_0():
    ...
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_3():
    ...
    exp_counts = [2.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_7():
    ...
    exp_counts = [6.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_15():
    ...
    exp_counts = [12.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_17():
    ...
    exp_counts = [0.0, 2.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_18():
    ...
    exp_counts = [0.0, 0.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_21():
    ...
    exp_counts = [2.0, 2.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_22():
    ...
    exp_counts = [2.0, 0.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_23():
    ...
    exp_counts = [4.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_29():
    ...
    exp_counts = [6.0, 2.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_30():
    ...
    exp_counts = [6.0, 0.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_31():
    ...
    exp_counts = [10.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_36():
    ...
    exp_counts = [0.0, 0.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_38():
    ...
    exp_counts = [2.0, 0.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_46():
    ...
    exp_counts = [6.0, 0.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_49():
    ...
    exp_counts = [0.0, 6.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_50():
    ...
    exp_counts = [0.0, 2.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_51():
    ...
    exp_counts = [0.0, 4.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_52():
    ...
    exp_counts = [0.0, 2.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_54():
    ...
    exp_counts = [2.0, 2.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_57():
    ...
    exp_counts = [2.0, 6.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_58():
    ...
    exp_counts = [2.0, 2.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_59():
    ...
    exp_counts = [4.0, 4.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_60():
    ...
    exp_counts = [2.0, 2.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_62():
    ...
    exp_counts = [6.0, 2.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_63():
    ...
    exp_counts = [8.0, 2.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_72():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_74():
    ...
    exp_counts = [2.0, 0.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_78():
    ...
    exp_counts = [6.0, 0.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_88():
    ...
    exp_counts = [0.0, 2.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_90():
    ...
    exp_counts = [2.0, 2.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_92():
    ...
    exp_counts = [2.0, 2.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_94():
    ...
    exp_counts = [6.0, 2.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_108():
    ...
    exp_counts = [2.0, 2.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_110():
    ...
    exp_counts = [6.0, 2.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_113():
    ...
    exp_counts = [0.0, 12.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_114():
    ...
    exp_counts = [0.0, 6.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_115():
    ...
    exp_counts = [0.0, 10.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_116():
    ...
    exp_counts = [0.0, 6.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_118():
    ...
    exp_counts = [2.0, 6.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_119():
    ...
    exp_counts = [2.0, 8.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_120():
    ...
    exp_counts = [0.0, 6.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_122():
    ...
    exp_counts = [2.0, 6.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_124():
    ...
    exp_counts = [2.0, 6.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_126():
    ...
    exp_counts = [6.0, 6.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_127():
    ...
    exp_counts = [6.0, 6.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_146():
    ...
    exp_counts = [0.0, 0.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_147():
    ...
    exp_counts = [0.0, 0.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_148():
    ...
    exp_counts = [0.0, 0.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_154():
    ...
    exp_counts = [2.0, 0.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_155():
    ...
    exp_counts = [4.0, 0.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_156():
    ...
    exp_counts = [2.0, 0.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_159():
    ...
    exp_counts = [8.0, 0.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_164():
    ...
    exp_counts = [0.0, 0.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_165():
    ...
    exp_counts = [0.0, 0.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_172():
    ...
    exp_counts = [2.0, 0.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_173():
    ...
    exp_counts = [4.0, 0.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_175():
    ...
    exp_counts = [8.0, 0.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_185():
    ...
    exp_counts = [2.0, 4.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_186():
    ...
    exp_counts = [2.0, 0.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_187():
    ...
    exp_counts = [4.0, 2.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_188():
    ...
    exp_counts = [2.0, 0.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_189():
    ...
    exp_counts = [4.0, 2.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_190():
    ...
    exp_counts = [4.0, 0.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_199():
    ...
    exp_counts = [4.0, 2.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_202():
    ...
    exp_counts = [2.0, 0.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_203():
    ...
    exp_counts = [4.0, 0.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_204():
    ...
    exp_counts = [2.0, 0.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_205():
    ...
    exp_counts = [4.0, 0.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_206():
    ...
    exp_counts = [4.0, 0.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_207():
    ...
    exp_counts = [8.0, 0.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_210():
    ...
    exp_counts = [0.0, 2.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_211():
    ...
    exp_counts = [0.0, 4.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_212():
    ...
    exp_counts = [0.0, 2.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_214():
    ...
    exp_counts = [0.0, 2.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_215():
    ...
    exp_counts = [2.0, 4.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_216():
    ...
    exp_counts = [0.0, 2.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_217():
    ...
    exp_counts = [0.0, 4.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_218():
    ...
    exp_counts = [2.0, 2.0, 6.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_219():
    ...
    exp_counts = [2.0, 2.0, 4.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_220():
    ...
    exp_counts = [2.0, 2.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_221():
    ...
    exp_counts = [4.0, 4.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_222():
    ...
    exp_counts = [4.0, 2.0, 4.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_223():
    ...
    exp_counts = [6.0, 2.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_228():
    ...
    exp_counts = [0.0, 2.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_229():
    ...
    exp_counts = [0.0, 4.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_230():
    ...
    exp_counts = [0.0, 2.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_231():
    ...
    exp_counts = [2.0, 4.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_232():
    ...
    exp_counts = [0.0, 2.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_233():
    ...
    exp_counts = [0.0, 4.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_236():
    ...
    exp_counts = [2.0, 2.0, 0.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_237():
    ...
    exp_counts = [2.0, 2.0, 0.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_238():
    ...
    exp_counts = [4.0, 2.0, 0.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_239():
    ...
    exp_counts = [6.0, 2.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_243():
    ...
    exp_counts = [0.0, 8.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_245():
    ...
    exp_counts = [0.0, 8.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_246():
    ...
    exp_counts = [0.0, 4.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_248():
    ...
    exp_counts = [0.0, 4.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_249():
    ...
    exp_counts = [0.0, 8.0, 0.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_250():
    ...
    exp_counts = [2.0, 4.0, 4.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_251():
    ...
    exp_counts = [2.0, 6.0, 2.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_252():
    ...
    exp_counts = [2.0, 4.0, 0.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_253():
    ...
    exp_counts = [2.0, 6.0, 0.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_254():
    ...
    exp_counts = [4.0, 4.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_280():
    ...
    exp_counts = [0.0, 0.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_310():
    ...
    exp_counts = [2.0, 2.0, 6.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_317():
    ...
    exp_counts = [4.0, 4.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_318():
    ...
    exp_counts = [4.0, 2.0, 4.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_328():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_329():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_332():
    ...
    exp_counts = [2.0, 0.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_333():
    ...
    exp_counts = [4.0, 0.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_335():
    ...
    exp_counts = [8.0, 0.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_348():
    ...
    exp_counts = [2.0, 0.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_349():
    ...
    exp_counts = [4.0, 2.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_350():
    ...
    exp_counts = [4.0, 0.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_360():
    ...
    exp_counts = [0.0, 2.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_361():
    ...
    exp_counts = [0.0, 4.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_362():
    ...
    exp_counts = [0.0, 2.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_363():
    ...
    exp_counts = [2.0, 4.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_364():
    ...
    exp_counts = [2.0, 2.0, 0.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_365():
    ...
    exp_counts = [2.0, 2.0, 0.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_366():
    ...
    exp_counts = [4.0, 2.0, 0.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_367():
    ...
    exp_counts = [6.0, 2.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_374():
    ...
    exp_counts = [2.0, 4.0, 4.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_377():
    ...
    exp_counts = [0.0, 8.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_378():
    ...
    exp_counts = [0.0, 4.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_380():
    ...
    exp_counts = [2.0, 4.0, 0.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_381():
    ...
    exp_counts = [2.0, 6.0, 0.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_396():
    ...
    exp_counts = [2.0, 0.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_397():
    ...
    exp_counts = [6.0, 0.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_402():
    ...
    exp_counts = [0.0, 0.0, 12.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_403():
    ...
    exp_counts = [0.0, 0.0, 10.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_404():
    ...
    exp_counts = [0.0, 0.0, 6.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_407():
    ...
    exp_counts = [2.0, 0.0, 8.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_408():
    ...
    exp_counts = [0.0, 0.0, 6.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_412():
    ...
    exp_counts = [2.0, 0.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_413():
    ...
    exp_counts = [6.0, 2.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_415():
    ...
    exp_counts = [6.0, 0.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_420():
    ...
    exp_counts = [0.0, 0.0, 2.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_421():
    ...
    exp_counts = [0.0, 0.0, 2.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_422():
    ...
    exp_counts = [0.0, 0.0, 4.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_423():
    ...
    exp_counts = [2.0, 0.0, 4.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_424():
    ...
    exp_counts = [0.0, 0.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_426():
    ...
    exp_counts = [0.0, 0.0, 4.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_428():
    ...
    exp_counts = [2.0, 0.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_429():
    ...
    exp_counts = [4.0, 0.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_430():
    ...
    exp_counts = [2.0, 0.0, 2.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_431():
    ...
    exp_counts = [6.0, 0.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_435():
    ...
    exp_counts = [0.0, 2.0, 8.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_437():
    ...
    exp_counts = [0.0, 2.0, 4.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_438():
    ...
    exp_counts = [0.0, 0.0, 8.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_440():
    ...
    exp_counts = [0.0, 0.0, 4.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_442():
    ...
    exp_counts = [0.0, 0.0, 8.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_443():
    ...
    exp_counts = [2.0, 2.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_444():
    ...
    exp_counts = [2.0, 0.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_445():
    ...
    exp_counts = [4.0, 2.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_446():
    ...
    exp_counts = [2.0, 0.0, 6.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_456():
    ...
    exp_counts = [0.0, 0.0, 2.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_457():
    ...
    exp_counts = [0.0, 0.0, 2.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_458():
    ...
    exp_counts = [0.0, 0.0, 4.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_459():
    ...
    exp_counts = [2.0, 0.0, 4.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_460():
    ...
    exp_counts = [2.0, 0.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_461():
    ...
    exp_counts = [4.0, 0.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_462():
    ...
    exp_counts = [2.0, 0.0, 2.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_463():
    ...
    exp_counts = [6.0, 0.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_473():
    ...
    exp_counts = [0.0, 2.0, 4.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_474():
    ...
    exp_counts = [0.0, 0.0, 8.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_476():
    ...
    exp_counts = [2.0, 0.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_478():
    ...
    exp_counts = [2.0, 0.0, 6.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_480():
    ...
    exp_counts = [0.0, 2.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_481():
    ...
    exp_counts = [0.0, 6.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_482():
    ...
    exp_counts = [0.0, 2.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_483():
    ...
    exp_counts = [2.0, 6.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_484():
    ...
    exp_counts = [0.0, 2.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_485():
    ...
    exp_counts = [0.0, 4.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_486():
    ...
    exp_counts = [0.0, 2.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_487():
    ...
    exp_counts = [2.0, 4.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_488():
    ...
    exp_counts = [0.0, 2.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_489():
    ...
    exp_counts = [0.0, 4.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_490():
    ...
    exp_counts = [0.0, 2.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_492():
    ...
    exp_counts = [2.0, 2.0, 2.0, 6.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_493():
    ...
    exp_counts = [2.0, 2.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_495():
    ...
    exp_counts = [4.0, 2.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_499():
    ...
    exp_counts = [0.0, 6.0, 6.0, 0.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_500():
    ...
    exp_counts = [0.0, 2.0, 2.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_501():
    ...
    exp_counts = [0.0, 6.0, 2.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_502():
    ...
    exp_counts = [0.0, 2.0, 6.0, 2.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_504():
    ...
    exp_counts = [0.0, 2.0, 2.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_505():
    ...
    exp_counts = [0.0, 6.0, 2.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_506():
    ...
    exp_counts = [0.0, 2.0, 6.0, 0.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_509():
    ...
    exp_counts = [2.0, 4.0, 2.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_510():
    ...
    exp_counts = [2.0, 2.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_552():
    ...
    exp_counts = [0.0, 0.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_566():
    ...
    exp_counts = [2.0, 2.0, 2.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_571():
    ...
    exp_counts = [4.0, 4.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_574():
    ...
    exp_counts = [4.0, 2.0, 2.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_602():
    ...
    exp_counts = [2.0, 2.0, 2.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_606():
    ...
    exp_counts = [4.0, 2.0, 2.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_622():
    ...
    exp_counts = [4.0, 0.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_630():
    ...
    exp_counts = [2.0, 4.0, 2.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_634():
    ...
    exp_counts = [2.0, 4.0, 2.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_636():
    ...
    exp_counts = [0.0, 4.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_667():
    ...
    exp_counts = [4.0, 0.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_676():
    ...
    exp_counts = [0.0, 0.0, 0.0, 12.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_677():
    ...
    exp_counts = [0.0, 0.0, 0.0, 10.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_679():
    ...
    exp_counts = [2.0, 0.0, 0.0, 8.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_680():
    ...
    exp_counts = [0.0, 0.0, 0.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_683():
    ...
    exp_counts = [6.0, 2.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_687():
    ...
    exp_counts = [6.0, 0.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_693():
    ...
    exp_counts = [0.0, 2.0, 0.0, 8.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_694():
    ...
    exp_counts = [0.0, 0.0, 2.0, 8.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_696():
    ...
    exp_counts = [0.0, 0.0, 0.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_699():
    ...
    exp_counts = [4.0, 2.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_700():
    ...
    exp_counts = [0.0, 0.0, 0.0, 8.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_701():
    ...
    exp_counts = [2.0, 2.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_702():
    ...
    exp_counts = [2.0, 0.0, 2.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_712():
    ...
    exp_counts = [0.0, 0.0, 0.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_713():
    ...
    exp_counts = [0.0, 0.0, 0.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_716():
    ...
    exp_counts = [0.0, 0.0, 0.0, 4.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_717():
    ...
    exp_counts = [2.0, 0.0, 0.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_718():
    ...
    exp_counts = [2.0, 0.0, 0.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_719():
    ...
    exp_counts = [6.0, 0.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_723():
    ...
    exp_counts = [0.0, 4.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_725():
    ...
    exp_counts = [2.0, 6.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_727():
    ...
    exp_counts = [2.0, 4.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_730():
    ...
    exp_counts = [2.0, 2.0, 6.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_731():
    ...
    exp_counts = [2.0, 2.0, 4.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_732():
    ...
    exp_counts = [0.0, 2.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_745():
    ...
    exp_counts = [0.0, 2.0, 0.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_746():
    ...
    exp_counts = [2.0, 0.0, 2.0, 4.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_748():
    ...
    exp_counts = [0.0, 0.0, 0.0, 8.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_750():
    ...
    exp_counts = [2.0, 0.0, 0.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_757():
    ...
    exp_counts = [0.0, 6.0, 0.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_758():
    ...
    exp_counts = [0.0, 2.0, 2.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_760():
    ...
    exp_counts = [0.0, 2.0, 0.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_761():
    ...
    exp_counts = [0.0, 6.0, 0.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_764():
    ...
    exp_counts = [0.0, 2.0, 0.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_766():
    ...
    exp_counts = [2.0, 2.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_822():
    ...
    exp_counts = [2.0, 2.0, 6.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_823():
    ...
    exp_counts = [2.0, 2.0, 4.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_825():
    ...
    exp_counts = [2.0, 6.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_827():
    ...
    exp_counts = [2.0, 4.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_839():
    ...
    exp_counts = [6.0, 2.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_840():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 12.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_841():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 10.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_843():
    ...
    exp_counts = [2.0, 0.0, 0.0, 0.0, 8.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_847():
    ...
    exp_counts = [6.0, 0.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_855():
    ...
    exp_counts = [4.0, 2.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_857():
    ...
    exp_counts = [0.0, 2.0, 0.0, 0.0, 8.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_858():
    ...
    exp_counts = [0.0, 0.0, 2.0, 0.0, 8.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_860():
    ...
    exp_counts = [0.0, 0.0, 0.0, 0.0, 8.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_861():
    ...
    exp_counts = [2.0, 2.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_862():
    ...
    exp_counts = [2.0, 0.0, 2.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_876():
    ...
    exp_counts = [0.0, 0.0, 0.0, 2.0, 8.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_878():
    ...
    exp_counts = [2.0, 0.0, 0.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_889():
    ...
    exp_counts = [0.0, 6.0, 0.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_890():
    ...
    exp_counts = [0.0, 2.0, 2.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_892():
    ...
    exp_counts = [0.0, 2.0, 0.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_894():
    ...
    exp_counts = [2.0, 2.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_917():
    ...
    exp_counts = [2.0, 2.0, 4.0, 4.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_921():
    ...
    exp_counts = [2.0, 2.0, 4.0, 0.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_924():
    ...
    exp_counts = [0.0, 0.0, 4.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_937():
    ...
    exp_counts = [2.0, 2.0, 0.0, 4.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_938():
    ...
    exp_counts = [0.0, 0.0, 2.0, 4.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_950():
    ...
    exp_counts = [0.0, 0.0, 6.0, 6.0, 0.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_952():
    ...
    exp_counts = [0.0, 0.0, 2.0, 2.0, 4.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_954():
    ...
    exp_counts = [0.0, 0.0, 6.0, 2.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_956():
    ...
    exp_counts = [0.0, 0.0, 2.0, 6.0, 2.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_986():
    ...
    exp_counts = [0.0, 0.0, 6.0, 0.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_988():
    ...
    exp_counts = [0.0, 0.0, 2.0, 2.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
...
def test_1004():
    ...
    exp_counts = [0.0, 0.0, 0.0, 6.0, 6.0]
    assert matches_orca(triu, 'A2_1', exp_counts)
